...
json_path = "./data/DA-2K/annotations.json"
depth_res_path = "./output/lap_nocolor_2_f"
raw_path = "./data/DA-2K"
output_folder = "./DA-2K-eval/lap_nocolor_2_f"
...
for image_path, annotations in data.items():
    raw_img_path = os.path.join(raw_path, image_path)
    ...
    for config in model_configs:
        ...
        for annotation in annotations:
            ...
            # print(point1,point2)
            dep_1 = est_img[point1[0],point1[1]]
            dep_2 = est_img[point2[0],point2[1]]    
